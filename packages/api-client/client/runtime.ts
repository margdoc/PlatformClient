...
/**
 * MeetIT Courses API
 * Internal API for courses and lessons management.
 *
...
//import { AjaxObservable } from 'rxjs/src/internal/observable/dom/AjaxObservable';

export const BASE_PATH = 'http://localhost:8000'.replace(/\/+$/, '');


const ajaxConstructor: (args: AjaxRequest) => Observable<AjaxResponse> = (args) => {
